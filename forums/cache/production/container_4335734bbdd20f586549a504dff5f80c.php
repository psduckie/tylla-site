...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000693ed4590000000029d83e88(
...
class phpbbtemplatetwiglexer_00000000693ed4590000000029d83e88 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d90513e8cf41972748404 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d90513e8cf4f612474534 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d90513e8cf1b098064289 = array(
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, 'set_environment', array('env' => $env), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        return $this->valueHolder5d90513e8cf41972748404->set_environment($env);
    }
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        return $this->valueHolder5d90513e8cf41972748404->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        return $this->valueHolder5d90513e8cf41972748404->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d90513e8cf4f612474534 = $initializer;
    }
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__get', array('name' => $name), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        if (isset(self::$publicProperties5d90513e8cf1b098064289[$name])) {
            return $this->valueHolder5d90513e8cf41972748404->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d90513e8cf41972748404;
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__isset', array('name' => $name), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__unset', array('name' => $name), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;
    ...
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__clone', array(), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        $this->valueHolder5d90513e8cf41972748404 = clone $this->valueHolder5d90513e8cf41972748404;
    }

    public function __sleep()
    {
        $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, '__sleep', array(), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;

        return array('valueHolder5d90513e8cf41972748404');
    }
    ...
    {
        return $this->initializer5d90513e8cf4f612474534;
    }
    ...
    {
        return $this->initializer5d90513e8cf4f612474534 && ($this->initializer5d90513e8cf4f612474534->__invoke($valueHolder5d90513e8cf41972748404, $this, 'initializeProxy', array(), $this->initializer5d90513e8cf4f612474534) || 1) && $this->valueHolder5d90513e8cf41972748404 = $valueHolder5d90513e8cf41972748404;
    }
    ...
    {
        return null !== $this->valueHolder5d90513e8cf41972748404;
    }
    ...
    {
        return $this->valueHolder5d90513e8cf41972748404;
    }
